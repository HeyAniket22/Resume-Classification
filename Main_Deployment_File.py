...
st.title('Model Deployment: Resume Classification')

st.header('User Input Resume')
st.sidebar.subheader('File_Description')

html_temp = """
    <div style="background-color:Blue;padding:7px">
...
def text_preprocessing(df):
    ...
    html_temp = """
        <div style="background-color:deeppink;padding:5px">
...
#st.write(y_pred)
  ...
  st.sidebar.text("'Project Done By Group6\n @ Mr Aniket More,\n  Bindiya Chavan ,\n Roshni & Others  '")
